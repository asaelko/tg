...
type TL_chat struct {
	...
	admins_enabled     TL // flags_3?true
	admin              TL // flags_4?true
...
type TL_auth_sentCode struct {
	flags            TL // #
	phone_registered TL // flags_0?true
...
type TL_inputPeerNotifySettings struct {
	flags         TL // #
	show_previews TL // flags_0?true
	silent        TL // flags_1?true
	mute_until    int32
	sound         string
}
...
type TL_user struct {
	...
	restriction_reason     TL // flags_18?string
...
type TL_channel struct {
	...
	date               int32
	version            int32
	restriction_reason TL // flags_9?string
}
...
type TL_inputBotInlineResult struct {
	...
	thumb_url    TL // flags_4?string
	content_url  TL // flags_5?string
	content_type TL // flags_5?string
	w            TL // flags_6?int
	h            TL // flags_6?int
	duration     TL // flags_7?int
...
func (e TL_chat) encode() []byte {
	...
	x.Bytes(e.admins_enabled.encode())
	x.Bytes(e.admin.encode())
...
func (e TL_channel) encode() []byte {
	...
	x.Bytes(e.kicked.encode())
	x.Bytes(e.left.encode())
	x.Bytes(e.editor.encode())
	x.Bytes(e.moderator.encode())
	x.Bytes(e.broadcast.encode())
	x.Bytes(e.verified.encode())
	x.Bytes(e.megagroup.encode())
	x.Bytes(e.restricted.encode())
	x.Bytes(e.democracy.encode())
...
func (e TL_inputBotInlineResult) encode() []byte {
	...
	x.Bytes(e.thumb_url.encode())
	x.Bytes(e.content_url.encode())
	x.Bytes(e.content_type.encode())
	x.Bytes(e.w.encode())
	x.Bytes(e.h.encode())
	x.Bytes(e.duration.encode())
